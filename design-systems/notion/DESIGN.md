...
- "Design an alternating section layout: white sections alternate with warm white (#f6f5f4) sections. Each section has 64-80px vertical padding, 最大宽度 1200px centered. Section heading at 48px weight 700, line-height 1.00, letter-spacing -1.5px."
