...
- **背景色**: Transparent (inherits black page background)
...
- **Content areas**: Centered within 1200px 最大宽度 containers
...
| Desktop Large | 1280-1440px | Full layout, hero at 120px display, 最大宽度 containers |
